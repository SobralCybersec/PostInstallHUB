...
# ---------------------------------------------------------------------------
_shells_detect_pm() {
  if is_installed apt-get;  then echo apt;    return; fi
  if is_installed pacman;   then echo pacman; return; fi
  if is_installed dnf;      then echo dnf;    return; fi
  if is_installed zypper;   then echo zypper; return; fi
  echo unknown
}
