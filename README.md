...
|---|---|---|---|
| `jakoolit` | Hyprland | All distros incl. NixOS | [LinuxBeginnings/Hyprland-Dots](https://github.com/LinuxBeginnings/Hyprland-Dots) |
...
| `UBUNTU_UNSNAP=1` | Remove Snap entirely; restore Firefox (Mozilla APT) + `gnome-software` (mutually exclusive with `UBUNTU_SNAP`) | `0` |
| `ARCH_DOCKER=1` | Install Docker + add user to group | `0` |
| `ARCH_LTS=1` | Install LTS kernel (`linux-lts`) | `0` |
| `ARCH_ZRAM=1` | zram compressed swap (ram/2, zstd) + `earlyoom` | `0` |
...
| `ENDEAVOUR_ZRAM=1` | zram compressed swap (ram/2, zstd) + `earlyoom` | `0` |
...
# Full run with all optional steps
$env:WINDOWS_TWEAKS   = "1"   # winrift tweaks (Invoke-Step2Winrift)
$env:WINDOWS_DEBLOAT  = "1"   # Win11Debloat CLI + offline fallback (Invoke-Step3Bloat)
$env:WINDOWS_DEV      = "1"   # dev environment (Invoke-Step5DevEnv)
$env:WINDOWS_GAMING   = "1"   # gaming stack (Invoke-Step6Gaming)
$env:WINDOWS_ACTIVATE = "1"   # Windows activation via MAS — irm https://get.activated.win | iex
.\scripts\windows\setup.ps1
```
...
**Jakoolit Hyprland Dots**: [LinuxBeginnings/Hyprland-Dots](https://github.com/LinuxBeginnings/Hyprland-Dots) (fork of [JaKooLit/Hyprland-Dots](https://github.com/JaKooLit/Hyprland-Dots)) <img src="https://go-skill-icons.vercel.app/api/icons?i=linux&size=32" width="40" />
...
**EndeavourOS Post-Install** (base for `endeavour.sh`): [BrandowLucas/Post-Install-Script](https://github.com/BrandowLucas/Post-Install-Script) <img src="https://go-skill-icons.vercel.app/api/icons?i=bash&size=32" width="40" />

</h2>

<h2 align="center">

**Winrift** (Windows tweaks, wrapped by `setup.ps1`): [emylfy/winrift](https://github.com/emylfy/winrift) <img src="https://go-skill-icons.vercel.app/api/icons?i=powershell&size=32" width="40" />
...
**yay** (AUR helper): [Jguer/yay](https://github.com/Jguer/yay) <img src="https://go-skill-icons.vercel.app/api/icons?i=arch&size=32" width="40" />

</h2>

<h2 align="center">

**Determinate Nix installer**: [DeterminateSystems/nix-installer](https://github.com/DeterminateSystems/nix-installer) <img src="https://go-skill-icons.vercel.app/api/icons?i=nix&size=32" width="40" />
...
**makeresolvedeb** (DaVinci Resolve packaging): [Daniel Tufvesson](https://www.danieltufvesson.com/makeresolvedeb) <img src="https://go-skill-icons.vercel.app/api/icons?i=linux&size=32" width="40" />

</h2>

<h2 align="center">

**XSStrike** (Kali preset): [s0md3v/XSStrike](https://github.com/s0md3v/XSStrike) <img src="https://go-skill-icons.vercel.app/api/icons?i=python&size=32" width="40" />

</h2>

<h2 align="center">

**tlshelpers** (Kali preset): [hannob/tlshelpers](https://github.com/hannob/tlshelpers) <img src="https://go-skill-icons.vercel.app/api/icons?i=bash&size=32" width="40" />

</h2>

<h2 align="center">

**shosubgo** (Kali preset): [incogbyte/shosubgo](https://github.com/incogbyte/shosubgo) <img src="https://go-skill-icons.vercel.app/api/icons?i=go&size=32" width="40" />

</h2>

<h2 align="center">

**SubDomainizer** (Kali preset): [nsonaniya2010/SubDomainizer](https://github.com/nsonaniya2010/SubDomainizer) <img src="https://go-skill-icons.vercel.app/api/icons?i=python&size=32" width="40" />

</h2>

<h2 align="center">

**dnmasscan** (Kali preset): [rastating/dnmasscan](https://github.com/rastating/dnmasscan) <img src="https://go-skill-icons.vercel.app/api/icons?i=bash&size=32" width="40" />

</h2>

<h2 align="center">

**dorks-eye** (Kali preset): [BullsEye0/dorks-eye](https://github.com/BullsEye0/dorks-eye) <img src="https://go-skill-icons.vercel.app/api/icons?i=python&size=32" width="40" />

</h2>

<h2 align="center">

**blue_eye** (Kali preset): [BullsEye0/blue_eye](https://github.com/BullsEye0/blue_eye) <img src="https://go-skill-icons.vercel.app/api/icons?i=python&size=32" width="40" />

</h2>

<h2 align="center">

**ghost_eye** (Kali preset): [BullsEye0/ghost_eye](https://github.com/BullsEye0/ghost_eye) <img src="https://go-skill-icons.vercel.app/api/icons?i=python&size=32" width="40" />

</h2>

<p align="center">
 <sub>These third-party projects are installed, cloned or sourced by the post-install scripts. All rights and credit belong to their respective authors. Distribution package repositories and vendor download mirrors used by the scripts (RPM Fusion, Packman, Flathub, Chaotic-AUR, deb-multimedia, NVIDIA, CUDA, Google, etc.) remain the property of their respective maintainers and vendors.</sub>
</p>
...
<p align="center">
 <sub>Bundled dotfiles presets are the work of their upstream authors:</sub><br>
 <sub><code>jakoolit</code> — <a href="https://github.com/LinuxBeginnings/Hyprland-Dots">LinuxBeginnings/Hyprland-Dots</a> (fork of <a href="https://github.com/JaKooLit/Hyprland-Dots">JaKooLit/Hyprland-Dots</a>)</sub><br>
...
<p align="center">
 <sub>Post-install scripts build on:</sub><br>
 <sub>EndeavourOS installer — <a href="https://github.com/BrandowLucas/Post-Install-Script">BrandowLucas/Post-Install-Script</a></sub><br>
 <sub>Windows tweaks — <a href="https://github.com/emylfy/winrift">emylfy/winrift</a></sub>
</p>
